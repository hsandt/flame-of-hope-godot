...
func _start_swing():
	...
	# animation
	animation_player.play("Character_Swing_%s" % CARDINAL_DIRECTION_NAMES[$"../CharacterMotor"._direction])
...
func _stop_swing():
	...
	# animation
	animation_player.play("Character_Idle_%s" % CARDINAL_DIRECTION_NAMES[$"../CharacterMotor"._direction])
